...
public final class SmallNativeAdBinding implements ViewBinding {
  ...
  private SmallNativeAdBinding(@NonNull NativeAdView rootView, @NonNull TextView adAdvertiser,
  ...
  @NonNull
  public static SmallNativeAdBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SmallNativeAdBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.small_native_ad, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SmallNativeAdBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SmallNativeAdBinding((NativeAdView) rootView, adAdvertiser, adAppIcon, adBody,
