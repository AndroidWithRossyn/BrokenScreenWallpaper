...
public final class FullNativeAdParamBinding implements ViewBinding {
  @NonNull
  ...
  private FullNativeAdParamBinding(@NonNull NativeAdView rootView, @NonNull TextView adAdvertiser,
  ...
  @NonNull
  public static FullNativeAdParamBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FullNativeAdParamBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.full_native_ad_param, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FullNativeAdParamBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FullNativeAdParamBinding((NativeAdView) rootView, adAdvertiser, adAppIcon, adBody,
