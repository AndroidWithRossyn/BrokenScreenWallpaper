...
public final class SmallNativeAd1Binding implements ViewBinding {
  @NonNull
  ...
  private SmallNativeAd1Binding(@NonNull NativeAdView rootView, @NonNull TextView adAdvertiser,
  ...
  @NonNull
  public static SmallNativeAd1Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SmallNativeAd1Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.small_native_ad1, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SmallNativeAd1Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SmallNativeAd1Binding((NativeAdView) rootView, adAdvertiser, adAppIcon, adBody,
          adCallToAction, adHeadline, adPrice, adStars, adStore);
    }
